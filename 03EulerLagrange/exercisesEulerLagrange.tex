...
\item
	...
	\begin{minipage}[c][0cm][t]{0.3\textwidth}
		\includegraphics[width=0.75\textwidth]{figures/cmchap6_fig6_8.png}
	\end{minipage}
...
\item
	...
	\begin{minipage}[c][1cm][t]{0.3\textwidth}
		\includegraphics[width=0.75\textwidth]{figures/cmchap6_fig6_18.png}
	\end{minipage}
	Resultado:\\
	\(
...
\item
	...
	\end{minipage}
	\begin{minipage}[c][1cm][t]{0.3\textwidth}
		\includegraphics[width=0.75\textwidth]{figures/cmchap6_fig6_27.png}
	\end{minipage}
	\begin{enumerate}
