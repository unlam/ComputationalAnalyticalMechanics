...
\item
	\begin{minipage}[t][3.7cm]{0.7\textwidth}
		...
		A rigid bar of length $\ell_1$ and negligible mass has a particle of mass $m_1$ attached to one end. There is a second bar of negligible mass hanging from the first one, of length $\ell_2$, with a particle of mass $m_2$ attached to the other end too.		
	\end{minipage}
	\begin{minipage}[c][2cm][t]{0.3\textwidth}
