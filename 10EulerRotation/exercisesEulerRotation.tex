...
\begin{enumerate}
	...
	\begin{minipage}[c][0.5cm][t]{0.4\textwidth}
		\includegraphics[width=\textwidth]{figures/hibb21_4}
	\end{minipage}
	...
	\begin{minipage}[c][0.5cm][t]{0.35\textwidth}
		\includegraphics[width=\textwidth]{figures/cilindroPesas.png}
	\end{minipage}
	...
	\end{minipage}
	\begin{minipage}[c][0.5cm][t]{0.35\textwidth}
		\includegraphics[width=\textwidth]{figures/hibb21_6}
	\end{minipage}
...
\begin{minipage}[c][2cm][t]{0.3\textwidth}
	\includegraphics[width=\textwidth]{figures/hibb_14_21_58}
\end{minipage}
