...
\title{Essentials from Lanczos' \emph{The Variational Principles of Mechanics}}
...
The definition of the work function as only dependent on the generalized coordinates is too restrictive, since in well-know cases of forces derivable from work functions in which time \(t\) appears explicitly \(U= U(q_1, q_2, \ldots, q_n,t)\).
